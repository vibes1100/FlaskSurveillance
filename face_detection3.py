...
ssdpath= "C:\\Users\\Vaibs\\Downloads\\VITSem6\\IoT\\Project\\caffe-ssd"
PROTOTXT = os.path.sep.join([ssdpath, "MobileNetSSD_deploy.prototxt.txt"])
MODEL = os.path.sep.join([ssdpath, "MobileNetSSD_deploy.caffemodel"])
